...
static const char *fonts[]          = { "Iosevka:size=13", "monospace:size=13" };
...
static const char col_red[]         = "#ff0000"; /* red to improve selected client visibility */
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_masculine, togglescratch, {.v = scratchpadcmd } },
